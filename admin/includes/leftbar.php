<nav class="ts-sidebar mt-0">
    <ul class="ts-sidebar-menu">
        ...
        <li><a href="index.php"><i class="fa fa-dashboard"></i>Admin Dashboard</a></li>

        <li><a href="#"><i class="fa fa-files-o"></i> Staff</a>
            <ul>
                <li><a href="addLawyer.php">Add Lawyer</a></li>
                <li><a href="manage_lawyer.php">Manage Lawyer</a></li>
            </ul>
        </li>
